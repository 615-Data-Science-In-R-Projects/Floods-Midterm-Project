...
## Data Cleaning
Data Cleaning for this EDA that followed largely consisted of improving the way the data was labelled so that it was easier to parse, fixing some obvious issues with the way the data was stored and then getting each dataset in a good shape for the joins that would assemble the large dataset I used for most of my analysis. 
...
Then census data on poverty for 2020 and 20201 were read in, cleaned, combined. The biggest thing here was getting the names of the columns to be something easily parseable which was achieved through various lines of stringr code. The floods-fema data was left joined with this and voila.
```{r}
#| echo: false
#| message: false
