...
ggplot(comparisons_state_groups, aes(State,log(DAMAGE_PROPERTY)))+
  ...
  theme_classic()+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+
  labs(title="Is Property Damage higher in states where floods affect areas richer than the state average",
...
ggplot(comparisons_state_groups, aes(State,log(DAMAGE_CROPS)))+
  ...
  theme_classic()+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))+
  labs(title="Is Crop Damage higher in states where floods affect areas richer than the state average",
       y= "Property Damage (log)",
