---
title: "Floods - Deluge and Disaster"
...
geom_point()+geom_smooth(formula=y~x,method="lm", color="navy", lwd=0.5)+facet_wrap(~poverty)+labs(
  ...
  caption="Each point is a separate county\n Trend lines show if amount of assistance generally increases with number of declarations"
)+scale_color_manual(values=c("#19C5E4","orange","red", "#A169DD","#257505","#A0970C"))
...
geom_point()+geom_smooth(formula=y~x,method="lm", color="navy", lwd=0.5)+facet_wrap(~poverty)+labs(
  ...
  caption="Each point is a separate county\n Trend lines show if amount of assistance generally increases with number of declarations"
)+scale_color_manual(values=c("#19C5E4","orange","red", "#A169DD","#257505"))
...
ggplot(poverty_analysis_severity, aes(x=pa_amount, y=log(DAMAGE_PROPERTY), color=State))+
  ...
  caption="Each point is a separate county\n Trend lines show if damage generally increases with amount of public assistance"
)+scale_color_manual(values=c("#19C5E4","orange","red", "#A169DD","#257505"))+ylim(0,12)
