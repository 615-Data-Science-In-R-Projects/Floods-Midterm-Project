---
title: "Floods - Deluge, Disparity and Disaster"
...
It would appear that the large majority of floods happened in land-locked states in 2020 and 2021.

My focus, in this analysis, is to look at whether floods disproportionately affect poor areas and what relationship poverty has, if any, with FEMA claims. 
...
Moreover the federal governments response is generally distributed evenly relative to severity of the flood event and regardless of the poverty levels of the community affected. I would argue that the overall effect of this is to reinforce the income and wealth divides, particularly in places where flood incidents occur frequently. 

A few other points:
* Interestingly, it appears that landlocked US states are most affected by floods - from rainfall and not from coastal floods. 
* We haven't been able to conlcude whether property Damage is largely related to housing or infrastructure. This is a question that beggars answering and future analysis with relevant datasets might go some way to answering this. 
...
* Other states. Including in this would have confused the insights and distracted from teh findings - such as they are. 
